...
export default function HeroSection() {
  ...
  return (
    <section className="min-h-[100dvh] flex flex-col justify-end">
      <div className="max-w-[1400px] mx-auto w-full px-5 sm:px-8 lg:px-10 pb-8 lg:pb-16 pt-24 lg:pt-36">
        <div className="max-w-[560px]">
          <div className="label mb-3 lg:mb-5">Tikinti · Layihələndirmə · Təmir</div>
          <h1 className="heading-display text-ink mb-4 lg:mb-6">
            Bünövrədən
            <br />
          ...
          <p className="body-lg max-w-[380px] mb-6 lg:mb-8">
