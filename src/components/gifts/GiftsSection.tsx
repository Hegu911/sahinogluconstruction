...
export default function GiftsSection() {
  ...
  return (
    <section ref={ref} className="py-10 lg:py-16 border-b border-border">
      <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide -mx-5 px-5 sm:mx-0 sm:px-0 lg:overflow-visible">
          {gifts.map((card, i) => (
            <div
              key={card.title}
              className={`shrink-0 w-[260px] sm:w-auto sm:flex-1 bg-paper-dark border border-border p-5 lg:p-6 transition-all duration-700 hover:border-bronze group ${
