            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14">
              <div className="lg:col-span-7">
                ...
                <h1 className="heading-xl text-paper mb-4">
                  Başlamaq<br /><span className="italic text-accent">üçün bir addım</span>
                </h1>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 max-w-[440px]">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="text" required className="w-full px-3 py-2.5 bg-paper/[0.05] border border-paper/10 text-paper text-[0.8125rem] rounded-xl focus:outline-none focus:border-accent transition-colors" placeholder="Adınız" />
                      </div>
                      <div>
                        <label className="block text-[0.65rem] font-medium tracking-[0.06em] uppercase text-paper/25 mb-1.5">Telefon</label>
                        <input type="tel" required className="w-full px-3 py-2.5 bg-paper/[0.05] border border-paper/10 text-paper text-[0.8125rem] rounded-xl focus:outline-none focus:border-accent transition-colors" placeholder="+994" />
                      </div>
                    </div>
                    <div>
                      <label className="block text-[0.65rem] font-medium tracking-[0.06em] uppercase text-paper/25 mb-1.5">Layihə növü</label>
                      <select className="w-full px-3 py-2.5 bg-paper/[0.05] border border-paper/10 text-paper text-[0.8125rem] rounded-xl focus:outline-none focus:border-accent appearance-none">
                    ...
                    <div>
                      ...
                      <textarea rows={4} className="w-full px-3 py-2.5 bg-paper/[0.05] border border-paper/10 text-paper text-[0.8125rem] rounded-xl focus:outline-none focus:border-accent resize-none" placeholder="Qısa məlumat..." />
                    </div>
                    ...
                    {[
                      ...
                      <div key={item.label} className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          {item.href ? (
                            <a href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel={item.href.startsWith("http") ? "noopener noreferrer" : undefined} className="text-[0.8125rem] text-paper/60 hover:text-accent transition-colors">{item.value}</a>
                          ) : (
