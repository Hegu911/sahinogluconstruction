          ...
          <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14">
              <div className="lg:col-span-7">
                ...
                <p className="body-sm text-text-secondary max-w-[400px] mb-8 lg:mb-10">
                ...
                {submitted ? (
                  <div className="py-12 text-center border-t border-rule">
                    ...
                    <h2 className="heading-md text-text-primary mb-2">Mesajınız göndərildi</h2>
                    ...
                    {[
                      ...
                      <div key={item.label} className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          {item.href ? (
                            <a href={item.href} target={item.href.startsWith("http") ? "_blank" : undefined} rel={item.href.startsWith("http") ? "noopener noreferrer" : undefined} className="text-[0.8125rem] text-text-secondary hover:text-accent transition-colors">{item.value}</a>
                          ) : (
                            <span className="text-[0.8125rem] text-text-secondary">{item.value}</span>
                          )}
                        </div>
                      </div>
                    ))}
